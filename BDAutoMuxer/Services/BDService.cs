...
namespace BDAutoMuxer.Services
{
    public static class BDService
    {
        ...
        /// <summary>
        /// Queries the BDAutoMuxer Main Movie database for all discs that have the same volume label as the given disc,
        ...
        /// <returns>The first disc from the BDAutoMuxer database that has the same volume label and hash code as the given disc; otherwise null if none match.</returns>
        ...
        /// <summary>
        /// PUTs the given Disc to the BDAutoMuxer Main Movie DB.
        /// </summary>
