...
namespace BDAutoMuxerCore.BDInfo
{
    /// <summary>
    /// Codec identifier.
    /// </summary>
    ...
    {
        public static readonly IDictionary<TSStreamType, Icon> CodecIconMap
            = new Dictionary<TSStreamType, Icon>
                  {
                      { TSStreamType.AC3_AUDIO, CodecIcons.dd },
                      { TSStreamType.AC3_PLUS_AUDIO, CodecIcons.dd_plus },
                      { TSStreamType.AC3_PLUS_SECONDARY_AUDIO, CodecIcons.dd_plus },
                      { TSStreamType.AC3_TRUE_HD_AUDIO, CodecIcons.truehd },

                      { TSStreamType.DTS_AUDIO, CodecIcons.dts },
                      { TSStreamType.DTS_HD_AUDIO, CodecIcons.dts_hd },
                      { TSStreamType.DTS_HD_MASTER_AUDIO, CodecIcons.dts_hd },
                      { TSStreamType.DTS_HD_SECONDARY_AUDIO, CodecIcons.dts_hd },

                      { TSStreamType.LPCM_AUDIO, CodecIcons.lpcm },

                      { TSStreamType.MPEG1_AUDIO, CodecIcons.mpeg1_audio },
                      { TSStreamType.MPEG2_AUDIO, CodecIcons.mpeg2_audio },

                      { TSStreamType.AVC_VIDEO, CodecIcons.avc },
                      { TSStreamType.MPEG1_VIDEO, CodecIcons.mpeg1_video },
                      { TSStreamType.MPEG2_VIDEO, CodecIcons.mpeg2_video },
                      { TSStreamType.VC1_VIDEO, CodecIcons.vc1 },

                      { TSStreamType.PRESENTATION_GRAPHICS, CodecIcons.pgs },
                      { TSStreamType.SUBTITLE, CodecIcons.txt }
                  };

        public static Icon GetCodecIcon(TSStreamType streamType)
        {
            return CodecIconMap.ContainsKey(streamType) ? CodecIconMap[streamType] : CodecIcons.unknown;
        }
