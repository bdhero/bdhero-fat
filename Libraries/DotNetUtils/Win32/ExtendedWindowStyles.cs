...
namespace DotNetUtils.Win32
{
    ...
    public static class ExtendedWindowStyles
    {
        ...
        public const Int32 WS_EX_COMPOSITED = 0x02000000;
        ...
        /// </summary>
        public const Int32 WS_EX_NOREDIRECTIONBITMAP = 0x00200000;

        /// <summary>
        /// The window is an overlapped window.
        /// </summary>
        public const Int32 WS_EX_OVERLAPPEDWINDOW = WS_EX_WINDOWEDGE | WS_EX_CLIENTEDGE;

        /// <summary>
        /// The window is palette window, which is a modeless dialog box that presents an array of commands.
        /// </summary>
        public const Int32 WS_EX_PALETTEWINDOW = WS_EX_WINDOWEDGE | WS_EX_TOOLWINDOW | WS_EX_TOPMOST;
        ...
        /// SS_RIGHT or ES_RIGHT style, respectively. Using this style with button controls has
        ...
        /// than a normal title bar, and the window title is drawn using a smaller font. A tool window does not appear
        ...
        /// have been painted. The window appears transparent because the bits of underlying sibling windows have already been painted.
