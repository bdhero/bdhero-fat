		...
		public String SaveAs( String DefaultFileName )
		{
			if ( _masterPane != null )
			{
				...
				if ( DefaultFileName != null && DefaultFileName.Length > 0 )
				{
					...
					switch (ext)
					{
                        case ".png": _saveFileDialog.FilterIndex = 1; break;
                        case ".jpeg":
                        case ".jpg": _saveFileDialog.FilterIndex = 2; break;
						case ".gif": _saveFileDialog.FilterIndex = 3; break;
                        case ".bmp": _saveFileDialog.FilterIndex = 4; break;
                        case ".tiff":
						case ".tif": _saveFileDialog.FilterIndex = 5; break;
                        case ".emf": _saveFileDialog.FilterIndex = 6; break;
                    }
				...
				if ( _saveFileDialog.ShowDialog() == DialogResult.OK )
				{
					...
					if ( myStream != null )
					{
						if ( _saveFileDialog.FilterIndex == 6 )
						{
							myStream.Close();
