...
namespace BDHero
{
    public partial class FormSettings : Form
    {
        ...
        public FormSettings()
        {
            ...
            textBoxApiKey.Text = BDHeroSettings.ApiKey;
            checkBoxCheckForUpdates.Checked = BDHeroSettings.CheckForUpdates;
            checkBoxSelectHighestChannelCount.Checked = BDHeroSettings.SelectHighestChannelCount;
            checkBoxUseMainMovieDb.Checked = BDHeroSettings.UseMainMovieDb;
        ...
        private void InitAudienceLanguage()
        {
            ...
            var selectedIndex = comboBoxAudienceLanguage.Items.IndexOf(BDHeroSettings.AudienceLanguage);
            if (selectedIndex > -1)
        ...
        private void InitPreferredAudioCodecs()
        {
            ...
            foreach (var index in BDHeroSettings.PreferredAudioCodecs.Select(audioCodec => checkedListBoxAudioCodecs.Items.IndexOf(audioCodec)).Where(index => index > -1))
            {
        ...
        {
            BDHeroSettings.ApiKey = textBoxApiKey.Text;
            BDHeroSettings.CheckForUpdates = checkBoxCheckForUpdates.Checked;
            BDHeroSettings.AudienceLanguage = SelectedAudienceLanguage;
            BDHeroSettings.PreferredAudioCodecs = SelectedAudioCodecs;
            BDHeroSettings.SelectHighestChannelCount = checkBoxSelectHighestChannelCount.Checked;
            BDHeroSettings.UseMainMovieDb = checkBoxUseMainMovieDb.Checked;
    ...
    public static class BDHeroSettings
    {
